...
def select_shallow_thinking_agent(provider) -> str:
    ...
    SHALLOW_AGENT_OPTIONS = {
        ...
        "siliconflow": [
            ...
            ("DeepSeek-R1 - 推理增强模型", "deepseek-ai/DeepSeek-R1"),
            ("DeepSeek-V3.1 - 升级版DeepSeek模型", "deepseek-ai/DeepSeek-V3.1"),
            ("Qwen3-30B-A3B-Instruct - 通义千问3.0指令模型", "Qwen/Qwen3-30B-A3B-Instruct-2507"),
            ("Qwen3-30B-A3B-Thinking - 通义千问3.0思维模型", "Qwen/Qwen3-30B-A3B-Thinking-2507"),
        ],
        "alibaba dashscope": [
            ("DeepSeek-V3.1 - 深度求索推理模型", "deepseek-v3.1"),
            ("DeepSeek-R1 - 深度求索推理增强模型", "deepseek-r1"),
            ("DeepSeek-V3 - 深度求索对话模型", "deepseek-v3"),
            ("Qwen-Plus - 通义千问增强版", "qwen-plus"),
            ("Qwen-Turbo - 通义千问高速版", "qwen-turbo"),
            ("Qwen-Flash-2025-07-28 - 通义千问快速版最新", "qwen-flash-2025-07-28"),
